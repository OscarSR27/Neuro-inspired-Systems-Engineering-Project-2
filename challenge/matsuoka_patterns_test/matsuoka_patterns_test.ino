...
Pattern eight_coupling_left_down_right_up[NUMBER_MATSUOKA_NEURONS] = 
{
  /*Description  tao    b       T                                      a                                  x_i(0)*/
  {"Neuron-01",   1,   2.5,     12,     {0, 0, 0, 0, 0, 0, 0, cs, cs, 0, 0, 0, 0, 0}, 0},
  {"Neuron-02",   1,   2.5,     12,     {cs, 0, 0, 0, 0, 0, 0, cs, 0, cs, 0, 0, 0, 0}, 0},
  {"Neuron-03",   1,   2.5,     12,     {0, cs, 0, 0, 0, 0, 0, 0, cs, cs, cs, 0, 0, 0}, 0},
  {"Neuron-04",   1,   2.5,     12,     {0, 0, cs, 0, 0, 0, 0, 0, 0, cs, 0, cs, 0, 0}, 0},
  {"Neuron-05",   1,   2.5,     12,     {0, 0, 0, cs, 0, 0, 0, 0, 0, 0, cs, cs, cs, 0}, 0},
  {"Neuron-06",   1,   2.5,     12,     {0, 0, 0, 0, cs, 0, 0, 0, 0, 0, 0, cs, 0, cs}, 0},
  {"Neuron-07",   1,   2.5,     12,     {0, 0, 0, 0, 0, cs, 0, 0, 0, 0, 0, 0, cs, cs}, 0},
  {"Neuron-08",   1,   2.5,     12,     {0, cs, 0, 0, 0, 0, 0, 0, cs, 0, 0, 0, 0, 0}, 0},
  {"Neuron-09",   1,   2.5,     12,     {cs, cs, cs, 0, 0, 0, 0, 0, 0, cs, 0, 0, 0, 0}, 0},
  {"Neuron-10",   1,   2.5,     12,     {0, cs, 0, cs, 0, 0, 0, 0, 0, 0, cs, 0, 0, 0}, 0},
  {"Neuron-11",   1,   2.5,     12,     {0, 0, cs, cs, cs, 0, 0, 0, 0, 0, 0, cs, 0, 0}, 0},
  {"Neuron-12",   1,   2.5,     12,     {0, 0, 0, cs, 0, cs, 0, 0, 0, 0, 0, 0, cs, 0}, 0},
  {"Neuron-13",   1,   2.5,     12,     {0, 0, 0, 0, cs, cs, cs, 0, 0, 0, 0, 0, 0, cs}, 0},
  {"Neuron-14",   1,   2.5,     12,     {0, 0, 0, 0, 0, cs, 0, 0, 0, 0, 0, 0, 0, 0}, 0},
};
...
void setup()
{
  ...
  for (int i = 0; i < NUMBER_MATSUOKA_NEURONS; i++)
  {
    setup_matsuoka_neuron(&matsuoka_neuron[i],ladder_circle[i],ladder_circle[i].str);
  }
}
